...
export class MantenedorPage implements OnInit {
    ...
    usuario = new FormGroup({
      ...
      carrera: new FormControl('', [Validators.minLength(3), Validators.pattern('^[a-zA-Z]+$')]),
      semestre: new FormControl('', [Validators.pattern('[0-9]')]),
    });
    search = '';
 ...
 async  ngOnInit() {
    ...
    async modificar(){
      ...
      await this.storage.actualizarPersona(this.KEY_PERSONAS, this.usuario.value);
